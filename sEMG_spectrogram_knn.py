...
# from sklearn.svm import SVC  # Nu-l mai folosim
    ...
    for id in range(len(classes)):
        for file in os.listdir(classes[id]):
            ...
            for i in range(data.shape[0]):
                ...
                window_size = 5120  # Exemplu: 1 secundă la 1024 Hz
                overlap = int(window_size * 0.6)  # 60% suprapunere (ajustează după preferințe)
...
# Oversampling cu SMOTE (pentru clasa minoritară)
